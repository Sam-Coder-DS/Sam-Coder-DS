<h1 align="center">Hey there 👋, I'm Samarth Sharma</h1>
...
- 🎓 **B.Tech CSE (Data Science)** @ MRIIRS, Faridabad — **CGPA: 7.72**
- 🔧 Building real-world ML systems — customer segmentation, YouTube trend analyzers, AI resume screeners
- 📄 **IEEE Paper Presenter** — ICAICCIT 2025 (ML Framework for Binary Bioactivity Classification)
...
| Category | Skills |
|---|---|
| 🖥️ **Languages** | Python · C++ · C · SQL |
| 🧠 **Data Science & ML** | NumPy · Pandas · Scikit-learn · Matplotlib · Seaborn · KMeans · Isolation Forest · NLP (NLTK) |
| 🌐 **Web & Visualization** | Streamlit · Flask · HTML · CSS · Chart.js · REST API |
| ☁️ **Cloud & Platforms** | Microsoft Azure · IBM SkillsBuild · Oracle (23ai) |
| 🛠️ **Tools** | MS Excel · RapidMiner · GitHub · VS Code · Figma · Canva |
| 🗄️ **Core CS** | Data Structures · Algorithms · DBMS · Operating Systems · Computer Networks |
...
- 📄 **IEEE Paper Presenter** — ICAICCIT 2025 · ML Framework for Binary Bioactivity Classification
- ☁️ **Microsoft Azure AI Fundamentals** · **Azure Data Scientist Associate**
- 🏅 **IBM SkillsBuild** Data Analytics Internship Certificate
- 📊 **Oracle** — Vector AI Search Fundamentals (23ai)
- 🧠 **Udemy** — Microsoft Excel Basic to Advanced
- 🏋️ **TechSaksham AICTE** — Fitness Tracker App Certification
...
<p align="center">
  📬 Reach me at <a href="mailto:samarthsharma12004@gmail.com">samarthsharma12004@gmail.com</a>
</p>
